...
"It passed earlier" is not verification. If the code changed, run it again. This rule does not soften on any model, this one included — the self-checking this model already does internally is not a substitute for actually running the command and reading real output. See the note at the end of this file for what does and doesn't change here.
