...
- Is a one-line request actually hours of work? **Reading it narrow reads as ignoring it** — scope it broad, then confirm, rather than interpreting it small. This model reads instructions literally, so a one-liner is likely to get executed exactly as typed unless the scope is stated explicitly.
